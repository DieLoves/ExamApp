...
import { BookOpen, Calendar, Clock, User, XCircle } from "lucide-react"
...
export function ExamResults({
  ...
  return (
    <div className="space-y-6 exam-result">
      <div className="flex flex-col gap-2 mt-2 text-base">
        ...
        {disciplineName && (
          <div className="flex items-center gap-2">
            ...
            <span>Дисциплина: {disciplineName}</span>
          </div>
        )}
        <div className="flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full mt-6">
        <div className="flex flex-col items-center p-3 border rounded-lg">
          ...
          <div className="text-2xl sm:text-3xl font-bold">{finalScore.toFixed(1)}%</div>
        </div>
        <div className="flex flex-col items-center p-3 border rounded-lg">
          <div className="text-base font-medium mb-1">Баллы</div>
          <div className="text-2xl sm:text-3xl font-bold">{pointsScore}/100</div>
        </div>
        <div className="flex flex-col items-center p-3 border rounded-lg">
